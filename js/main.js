...
const menuItems = [
  ...
  },
  {
    ...
    name: "Veggie Supreme",
    description:
      "Bell peppers, onions, mushrooms, olives, tomatoes, mozzarella, tomato sauce",
    price: 15.99,
  ...
  },
  {
    ...
    description:
      "Buffalo chicken, blue cheese, mozzarella, buffalo sauce drizzle",
    price: 16.99,
...
const confirmationPickupTime = document.getElementById(
  ...
  try {
    ...
    Object.keys(itemsByCategory).forEach((category) => {
      ...
      itemsByCategory[category].forEach((item) => {
        ...
        if (menuItem) {
          // Only append if we got a valid menu item
